...
class TreeItemBase(models.Model):
    ...
    url = models.CharField(_('URL'), max_length=191, help_text=_('Exact URL or URL pattern (see "Additional settings") for this item.'), db_index=True)
    ...
    css = models.CharField(_('Extra CSS'), max_length=191, help_text=_('Optional css class to associate icons or other styling with the menu item.'), db_index=True, blank=True)
