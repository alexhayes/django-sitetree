...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TreeItem.isdivider'
        db.add_column(u'sitetree_treeitem', 'isdivider',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TreeItem.isheader'
        db.add_column(u'sitetree_treeitem', 'isheader',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TreeItem.isdivider'
        db.delete_column(u'sitetree_treeitem', 'isdivider')

        # Deleting field 'TreeItem.isheader'
        db.delete_column(u'sitetree_treeitem', 'isheader')
    ...
    models = {
        ...
        u'sitetree.treeitem': {
            ...
            'isdivider': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'isheader': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
