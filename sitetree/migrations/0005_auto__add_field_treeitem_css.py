...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TreeItem.css'
        db.add_column(u'sitetree_treeitem', 'css',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TreeItem.css'
        db.delete_column(u'sitetree_treeitem', 'css')
    ...
    models = {
        ...
        u'sitetree.treeitem': {
            ...
            'css': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '200', 'blank': 'True'}),
